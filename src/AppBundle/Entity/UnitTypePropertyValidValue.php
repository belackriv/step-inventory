 ...
 * @ORM\Table()
 */
Class UnitTypePropertyValidValue
{
	/**
	...
	/**
	 * @ORM\ManyToOne(targetEntity="UnitTypeProperty", inversedBy="validValues")
    ...
    {
        return ($this->getUnitTypeProperty()->isOwnedByOrganization($organization));
    }
